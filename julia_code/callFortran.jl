...
# compute_qoi_targets: Fortran wrapper to compute velocity, pressure, and vorticity.
...
#--------------- ENFORCE PRESSURE DROP CONDITION ---------------#
...
#= Note: the density should have already been computed. This routine simply accesses the
density and rescales it if appropriate. =#
...
#------------ THE MAIN ROUTINES TO GET THE SHEAR STRESS ------------#
