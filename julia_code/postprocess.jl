...
#= QUESTION: Was my idea here to postprocess the text files or the JLD files?
I need to determine the answer and put a comment here at the top of the file to explain.
=#
