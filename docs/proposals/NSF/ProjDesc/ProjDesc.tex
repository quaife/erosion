...
\todo[inline]{Nick to Bryan: These changes you made look good to me. Did you want to add anything else, or is it okay to delete the above todo notes?}
...
responsible for a large portion of the flux~\cite{Quaife2018}. 
\todo[inline]{There is no verb in the above sentence. Is there a word left out?}
To increase understanding of flow through eroded media, we will simulate
...
analysis can be used to describe the transport. Two of the most important
