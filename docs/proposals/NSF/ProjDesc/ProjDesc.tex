...
\end{figure}
 ...
 \todo[inline]{I guess I really took to your strategy of including an example simulation early on in the introduction to draw in the readers interest. So I moved this figure up to the introduction and added some provocative text. Plus there are some visual similarities with the geophysical images in Fig. 1, so it is nice to see them close to one another.}
