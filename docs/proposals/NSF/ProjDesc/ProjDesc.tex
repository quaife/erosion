...
\begin{wrapfigure}[13]{l}{0.4\textwidth}
  ...
  \caption{\label{fig:porelets} \em An eroding body at five equally time steps.  At the three intermediate time steps, the Stokesian velocity field in the bulk, which is nearly parabolic, is included.} 
\end{wrapfigure}
