...
Note: in my code, I used
\begin{equation}
f(L) = - \frac{1}{ \log \left( \frac{1}{2} \tanh \left( 2 L\right) \right) }
\end{equation}
This way, we have $f(L) \sim -1/ \log L$ as $L \to 0$, and $f(L)$ is positive for all values of $L$.
