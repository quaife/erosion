...
\end{equation}
With this simplification, I see a match between measuring resistivity via the drag \eqref{resdrag} versus measuring resistivity directly via \eqref{resmatrix}.
