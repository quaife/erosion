...
\todo[inline]{Nothing about the anomalous dispersion rate here}
At high porosities, the dispersion rate is close to 1, and this can be
caused by one of two reasons.  1) There is no measurable anomalous
dispersion; or, 2) The streamlines are too short to see the anomalous
dispersion.
...
corresponds to $\sigma_\lambda$ if no bodies were present.  At early
times, the particles undergo a ballistic motion, but once they have
traversed a few grains, the dispersion becomes super-dispersive.  The
dashed-dotted lines are lines of best fit with slopes $1.0644$
($\phi=95.1\%$), $1.0673$ ($\phi=85.09\%$), $1.0594$ ($\phi=75.15\%$),
$0.9664$ ($\phi=65.09\%$), $0.7766$ ($\phi=55.10\%$), $0.7475$
($\phi=45.08\%$), and $0.5607$ ($\phi=37.68\%$).}
\end{figure}
...
$U=1$ that occurs once all the bodies have eroded. \todo[inline]{S-H:
Let's bring the black dashed line closer to the blue line}}
\end{figure}
