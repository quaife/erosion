...
We could find the explanation from the trajectories of tracers in Fig.~\ref{fig:Eroding20tracer}. Since the direction of flow is from left to right, most of the tracers will not travel vertically but horizontally when the gaps or channels are too small.  }
