...
\begin{align}
  u_1(\xx) &= \Re (v[\tau_1](x)) + \Re (v'[\yy\cdot\eeta](x)) 
           -x_1\Re (v'[\eta_1](x)) - x_2\Re (v'[\eta_2](x)), \label{eqn:cauchy1}\\
...
\begin{align}
  \pderiv{u_1}{x_1}(\xx) &= \Re (v'[\tau_1](x)) + 
    ...
    x_1\Re (v''[\eta_1](x)) - x_2\Re (v''[\eta_2](x)), \label{eqn:pderiv1} \\
  \pderiv{u_1}{x_2}(\xx) &= - \Im (v'[\tau_1](x)) - 
    \Im (v''[\yy\cdot\eeta](x)) + x_1\Im (v''[\eta_1](x)) - 
    \Re (v'[\eta_2](x)) + x_2\Im (v''[\eta_2](x)),  \label{eqn:pderiv2}\\
...
in~\cite{bar-wu-vee2015} by starting with the Cauchy integral identities
{\color{red}
\begin{alignat}{3}
