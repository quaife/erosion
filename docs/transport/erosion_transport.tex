...
bodies 3 \& 4, 15 \& 16, and was also observed in previous work.
However, by resolving the interaction between bodies that are much
closer together than in previous work, we observe that very little
erosion occurs between certain pairs of bodies, at least initially.  For
instance the opening between bodies 1 \& 6, 3 \& 9, and 5 \& 13 grow
much slower than the opening between bodies 15 \& 16.  A common feature
of the pores that grow slowly is that they are nearly perpendicular to
the main flow direction, resulting in a small erosion rate.
...
decrease in the dispersion rate. In particular, the first 5\% of the
bodies have eroded, the particle spreading transitions from
...
research with a few promising algorithms recently
