...
has more jumps than the one in the case of 20 bodies. 
...
since there are more bodies in the former case. In Fig.~\ref{fig:Eroding100tort}(c) 
we use the data we got from local tortuosity $\tau(y)$
to find the difference of $\tau$ at the neighboring tracers and
draw 50 pairs of neighboring trajectories which have the largest difference of $\tau$
in Fig.~\ref{fig:Eroding100tort_traj}. 
The maximum of $\tau$ is 1.2547 and the minimum is 1.0003.
