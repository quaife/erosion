...
the velocity at the $y$-coordinate along $S$.  Under the assumptions
that the flow is incompressible and not reentrant, the tortuosity can be
equivalently measured as~\cite{dud-koz-mat2011}
\begin{align}
...
\todo[inline]{This doesn't seem right.  $\xx$ is already on the boundary
of the jth body, so $L_j$ should not be part of the criteria.  Should be
something more like equation (44).}
