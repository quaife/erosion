...
The velocity of flow from the left side of $\Omega$ is 
$$\vv=\begin{bmatrix} y+1 \\ 0 \end{bmatrix}.$$
...
$$\vv=U\begin{bmatrix} 1-y^2\\ 0\end{bmatrix},$$ 
...
In Fig.~\ref{fig:Eroding20area} we measure the area occupied by bodies and the flow rate $U$ quantifily during the eroding. At the beggining, 62.32\% of area of $[-1,1] \times [-1,1]$ is occupied by 20 bodies. Then the eroding speed is increasing
...
\begin{figure}[H]
\begin{center}
\includegraphics[width = 0.45 \textwidth]{./figs/porosity20dense}
\includegraphics[width = 0.45 \textwidth]{./figs/flow_rate20dense}
\caption{\label{fig:Eroding20area}  The area fraction of 20 nearly touching eroding bodies and the incoming flow rate of U verse time.}
\end{center}
\end{figure}
