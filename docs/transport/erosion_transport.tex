...
compute the velocity using the fast summation method.\todo[inline]{BQ:
Discuss how we don't do Barycentric everywhere since it involves several
$N$ body calculations, while the trapezoid rule only requires a single
one}
