...
the endding starting cross section. }  
...
the endding starting cross section x = 1 and 
...
\caption{\label{fig:Eroding100tort_traj} The largest 50 difference of the length of 
local tortuosity $\tau$ at two neighboring tracers in
