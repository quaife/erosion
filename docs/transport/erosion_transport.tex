...
\todo[inline]{Right now, this description has the reader looking at Fig.
8, but the bodies are not numbered in that figure, so they don't know
which ones are 1, 4, 6, 8 without flipping back and forth with the
previous figures to try to match corresponding bodes.} Since the flow is
