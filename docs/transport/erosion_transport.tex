...
if the difference of length of the neighboring trajectories is large. From this figure, we are able to 
tell the neighboring trajectories will be very different if they are separated by bodies. 
}
