...
\begin{figure}[H]
\begin{center}
\caption{The trajectories of tracers in the fluid with 20 bodies. The 6 snapshots are evenly spaced in time.}
\end{center}
\end{figure}
...
{\color{red}
The first nearly touching bodies case is 50 bodies in a Hagen-Poiseuille flow.
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusions}
\label{s:conclusions}
