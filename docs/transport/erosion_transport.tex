...
In Fig.~\ref{fig:Eroding20tort} we use tortuosity to analysis the effect of the geometrical structure on fluid velocity field. In Fig.~\ref{fig:Eroding20tort}(a) the graph represents the ratio of the x-component velocity u(-1, y) and its maximum velocity, namely, $u_{max}=6.2281 \times 10^{-4}$ with respect to equal spreading tracers at x=-1 and y in [-1,1]. }
