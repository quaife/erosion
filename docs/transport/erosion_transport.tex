...
a geometry that is largely heterogeneous and anisotropic, and this
affects the transfer other other quantities such as a contaminant or
heat~\cite{nil-sto1990,
...
bodies.  Given the solution of the incompressible Stokes equations in
an eroded porous geometry, we investigate different different but
related metrics to
