...
rule of thumb that is required for the trapezoid rule to achieve machine
epsilon accuracy.  By applying the Barycentric quadrature rule, we
stably simulate erosion at the much coarser resolution of $N_\iin = 256$
and $N_\out = 1024$ discretization points.
