...
instabilities.  Therefore, we modify the erosion rate, $V_\nn$ in
...
\end{align}
\todo[inline]{Sh: Should we use bold font for $\eeta$ in $D[*](\xx)$? }
...
In the numerical simulations, we use $N_p = 1000$ streamlines so
that the statistics have converged~\cite{bel-sal-rin1992}.  
\todo[inline]{Dump of text}
