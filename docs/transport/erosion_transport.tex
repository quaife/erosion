...
%=======
%\begin{center}
%  \includegraphics[height=0.227\textwidth]{./figs/100b_50}
%  \includegraphics[height=0.227\textwidth, trim=0cm 0cm 2.8cm 0cm, clip=true]
%    {./figs/100b_100}
%  \includegraphics[height=0.227\textwidth]{./figs/100b_150}
%  \includegraphics[height=0.227\textwidth]{./figs/100b_200}
%\end{center}
%\caption{\label{fig:Eroding100vort} 100 bodies eroding in a
%Hagen-Poiseuille flow. The four snapshots are equispaced in time, and
%the color is the fluid vorticity.  Erosion creates many channels
%connecting the inlet to the outlet.}
%>>>>>>> 90934916f4dbe677f0ad6f05331ec1c3515ddab7
\end{figure}
...
%A variety of numerical methods for the fluid solver are available
%including lattice-gas or lattice Boltzmann~\citep{kop-kat-tim1996,
%dar-mcc1998}, finite volumes~\citep{suo-liu-gan2019, den-ica-hid2018,
%sie-ili-pri-riv-gua2019}, finite
%differences~\citep{leb-ded-dav-bou2007, knu-car2005}, and cellular
%automata~\citep{rot1988}.  
...
%we are able to compute, for $\xx \in \Omega$, the deformation tensor,
...
%added to $\ssigma(\xx)$ for $\xx \in \bd\Omega$.  Finally, the
