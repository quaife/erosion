...
results in a geometry that is largely heterogeneous and anisotropic.
Others have studied transport in heterogeneous geometries (for example,
...
equations such as a lattice-gas model~\cite{kop-kat-tim1996}, finite
...
dea-leb-den-tar-bol-dav2013}, resulting in super-diffusive dispersion.
The dispersion depends on the amount of time trajectories spend in low
and high velocity regimes~\cite{ber-sch2001}.  Anomalous dispersion has
been investigated for a variety of porous geometries, but not in the
context of eroding porous geometries.
...
\begin{itemize}
  ...
  \item Annealing algorithm to create initial body configurations of
  \item Tracer trajectories at different time steps
  \item Compute the anomalous dispersion rate using similar techniques
  as the paper with Pietro~\cite{dea-qua-bir-jua2018}
...
the anomalous dispersion rate, the tortuosity, and the distribution the
gap sizes.
...
anomalous dispersion depends on the porosity and
...
decrease particle dispersion, meaning a larger anomalous dispersion
rate.
...
(37.68\%) and another six porosities during the eroding. The dashed line
correspondes to a porosity of 100\% and the dashed-dotted line is a line
of best fit with slope 0.5742.}
\end{figure}
