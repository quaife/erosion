...
to characterize the flow.  We compare our tortuosity and dispersion
rates with models available in the literature.  Finally, we analyze the
effect of erosion on the pore size distribution.
...
the packing of the bodies. Compared to our previous work, we are able to
