...
$\Omega$, the Barycentric quadrature rule for the exterior problem is
\begin{align}
  v(x) = \frac{1}{x-a} 
...
\end{align}
and the integrand is bounded for all $x$.  Therefore, upon applying the
quadrature rule and rearranging for $v'(x)$, we have
\begin{align}
...
\end{align}
Using a similar construction, the Barycentric quadrature rule to compute
$v'(x)$ in $\Omega^c$ is
\begin{align}
...
for all $x \in \Omega$.  Therefore, after applying the trapezoid rule
  and solving for $v''(x)$, we have the Barycentric quadrature rule
\begin{align}
...
\label{s:streamlines}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{Dump of earlier section for now ... need to fix how this
is worked into the section}
