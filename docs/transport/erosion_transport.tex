...
is a simply-connected interior domain.  Analogous formulas exist for
...
\begin{align}
  ...
  \label{eqn:Baryv}
\end{align}
\todo[inline]{Need to cite~\cite{ioa-pap-per1991}.  They write formulas
for $v''(x)$ in this paper.  Need to be clear wrt what we did and what
  others have done} 
