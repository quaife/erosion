...
\caption{\label{fig:Eroding20tort_all} The Eulerian and Lagrangian approach of tortuosity. 
...
\caption{\label{fig:Eroding100anomalous} The analysis of anomalous diffusion in
 100 bodies with respect to six porosities and the reference line of 100\% porosity.
The first moment (left) is the mean length of streamlines and the second moment (right) is the }
\end{figure}
