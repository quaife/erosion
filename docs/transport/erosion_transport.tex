...
is an unknown density function.  In Section~\ref{s:DLPcomplex}, we show
how the Stokes double-layer potential can also be expressed as the sum
of a Laplacian double-layer potential 
\begin{align}
...
$d$, $\lambda(y)$ is the length of the streamline that is initizalized
