...
even the initial size of body 4 is larger than the size of body 17.
This channel will keep expanding and the bodies around this channel will vanish earlier than others. 
After body 17, the next 8 vanishing bodies with respect to time are body 19 (as t=0.0312),  
...
All of these eight bodies are around this channel.
...
the tracers will not only travel horizontally but vertically. 
