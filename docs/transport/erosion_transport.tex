...
and draw the trajectories of neighboring tracers in Fig.~\ref{fig:Eroding20tort_traj}
if the difference of length of the neighboring trajectories is large. From Fig.~\ref{fig:Eroding20tort_traj},
...
The pair trajectories could be splitted by more than one body, 
for example in Fig.~\ref{fig:Eroding20tort_traj} the toppest red pair trajectories 
are splitted by three close bodies. 
}
...
\caption{\label{fig:Eroding20tort_traj} The largest 10 difference of the length of 
...
\caption{\label{fig:Eroding20tort_traj} The largest 50 difference of the length of 
local tortuosity $\tau$ at two neighboring tracers in
