...
to $x=2$ is held fixed at 2.  For equispaced instances of the
configuration are plotted in Figure~\ref{fig:Eroding20vort}.  The color
in these plots is the vorticity, and this can be used to determine
regions of high and low erosion---erosion happens fastest along regions
of the eroding bodies with a large vorticity in magnitude.  In
...
because of the larger initial area fraction.
