...
\todo[inline]{Talk about the different relationships between tortuosity
and porosity from the literature}
...
\todo[inline]{S-H: Can cut the ylimit at 1.3}
\caption{}
\end{subfigure}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
...
The dash line is the fitting line $\hat{T}(\phi)=1-p\ln\phi$ as $p=0.2228$ and 
the sum $S$ of squared residuals is 0.0166.}
\end{figure}
...
the sum $S$ of squared residuals is 0.0075.}
\end{figure}
