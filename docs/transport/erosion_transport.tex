...
$0.91$ ($\phi=65.02\%$), $0.91$ ($\phi=55.08\%$), $0.72$
($\phi=45.03\%$), $0.69$ ($\phi=35.05\%$), and $0.92$ ($\phi=30.67\%$).}
\caption[inline]{Fix this caption}
\end{figure}
...
\caption{}
\end{subfigure}
\caption{\label{fig:Eroding100gap_mean_var} (a): The mean of gaps with
respect to porosity $\phi$.  (b): The variance of gaps with respect to
porosity $\phi$.}
\end{figure}
