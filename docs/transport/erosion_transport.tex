...
To calculate tortuosity $T$ numerically, we use the simple quaduature rule
...
fluid during the bodies erosion in Fig.~\ref{fig:Eroding100vort} and 
measure the gap sizes between bodies in Fig.~\ref{fig:Eroding100gap} at four time steps.
