...
\end{align}
This scaling law is shown in the figure (red, dotted curve) and shows good agreement with the viscous drag. Of course, \eqref{viscdrag} is less accurate than the previous estimates since it does not take into account the normal direction of the surface, only the mean shear stress.
