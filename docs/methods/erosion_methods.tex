...
a channel flow.  By artificially fixing the area of the body as a function
...
We make two fundamental design choices: first, we restrict ourselves to
...
To simulate Stokesian erosion, it is essential to resolve the nonlocal
effects between the different bodies.  BIEs naturally resolve these
interactions, and they have been used extensively to simulate viscous
fluids in complex geometries, including porous media
...
more grains are eroding and being transported by the flow.  To address
the nearly-singular integrands, we use the fact that the grains are
