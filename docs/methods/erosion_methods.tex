...
These fixed-area simulations enable us to precisely characterize the changing geometry as it approaches a terminal state. In particular, we measure the aspect ratio of the body (the ratio of width to height) and the opening angle of the front/rear corner. As shown in Fig.~\ref{fig:arangle}(a)
