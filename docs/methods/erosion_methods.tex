...
\todo[inline]{Above, and throughout the paper, could we index the bodies with $m = 1, \dots M$, and reserve the index $k$ for Fourier components. When I see $k$ I always think wavenumber for some reason.}
