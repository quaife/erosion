...
Flow-induced erosion deteriorates and reshapes solid material over a range of scales found in nature, from large-scale land formations \cite{} down to smaller-scale structures and patterns \cite{}. Though less visible, these same forces are at work at the very smallest of scales, slowly deteriorating the individual constituents of porous media (e.g.~solid, sand, or clay), along with small-scale biological structures such as biofilms. Motivated by these small-scale applications, this work focuses on developing numerical methods to simulate the erosion of solid material in Stokes flow.

Recent work on high-Reynolds number erosion has recognized the importance of shape-flow feedback
