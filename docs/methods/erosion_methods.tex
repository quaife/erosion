...
\todo[inline]{Note: I took out 'in the Stokesian limit' because the vorticity matches the shear stress on the boundary no matter what the Reynolds number is.}
