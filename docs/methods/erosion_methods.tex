...
\end{align}
For a circular cylinder, $a$ is the radius and the prefactor $4 \pi$ above gives an exact result within the slender-body framework. To generalize to other shapes, we define $a = \sqrt{A/\pi}$ and fit $\ell$ to get $\ell = 2.3 a_0$.
