...
\end{equation}
subject to boundary conditions. The corresponding shear stress evaluated on the surface of the wedge is $\tau = \mu r^{\lambda-2} f''(\alpha)$. Thus, the wedge of uniform stress corresponds to $\lambda = 2$. For this value, the general solution for $f$ is 
\begin{equation}
