...
To further quantify our observations, Fig.~\ref{fig:mbodyplots} shows several measurements taken from the multibody simulations. In all cases, the black curves correspond to the 6-body simulation and gray curves to the 50-body simulation from Fig.~\ref{fig:50bodies}. First, Fig.~\ref{fig:mbodyplots}(a) shows the fraction of area occupied by the solid bodies as it varies in time. In the 6-body simulation, the initial configuration comprises about 40\% of the domain area, and this percentage steadily decreases as the bodies erode. The 50-body simulation shows a similar trend. Figure \ref{fig:mbodyplots}(b) shows how the flow rate, $\umax$, changes in time as a result of fixing the pressure drop across the cell. Notice that, in this figure, the vertical axis is logarithmic. Both simulations show the flow rate to increase rapidly, even during the early stages of erosion when the area fraction has not changed that significantly. In fact, due to the logarithmic axis, the nearly linear trend seen in the figures corresponds to exponential growth of $\umax$. The change in area-fraction alone is not enough to account for this rapid growth, implying that it is the way in which erosion reshapes the bodies that allows for high flow rates.
