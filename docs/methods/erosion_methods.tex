...
To evolve the boundaries, we use the {\thL} framework, which offers
certain advantages in stabilizing fluid-structure
...
curvature from developing, as these regions would reduce the accuracy of our fluid solver. We thus modify the normal velocity of each interface as follows
\begin{align}
  \label{eqn:Vn}
