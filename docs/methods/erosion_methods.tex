...
velocity} \\
V_\nn = \abs{\tau}, &\hspace{20pt} \xx \in \gamma,
&&\mbox{erosion model},
\end{split}
\end{equation}
where $V_\nn$ is the normal velocity of the interface and $\mu$ is the
...
constant of proportionality only sets the time scale, we let $V_\nn =
