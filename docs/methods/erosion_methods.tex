...
Flow-induced erosion reshapes solid material over a range of scales found in nature, from large-scale land formations \cite{han1969, coh-dev-sey-yi-szy-rot2015} down to human-scale structures and patterns \cite{daerr2003erosion}. Though less visible, these same forces are at work at the very smallest of scales, slowly deteriorating the individual constituents of porous media (e.g.~solid, sand, or clay) or biological structures like plaque and biofilms \cite{pic-van-hei2000, sha2002, gro-gij-van-fer-hat-van-yua-wen2007}. Motivated by these small-scale applications, we develop here numerical methods to simulate fluid-mechanical erosion of multiple solid bodies in Stokes flow --- the most relevant regime for groundwater flow and the aforementioned biological examples.

Recent work on in the high-Reynolds regime has highlighted the importance of the feedback between flow and morphology that occurs during erosion \cite{ris-moo-chi-she-zha2012, moo-ris-chi-zha-she2013, moore2017riemann}, as well as during related processes such as dissolution and melting \cite{Huang2015, kondratiuk2015steadily, rycroft2016asymmetric, cohen2016erosion}. In such cases, the flow alters the shape of the structure, which in turn modifies the surrounding flow, and so on --- a reciprocal process that can be summarized as `sculpting with flow'~\cite{ristroph2018sculpting}.
...
% Other possible refs for erosion: mit-spa2016, hewett2017evolution, moore2017riemann, lachaussee2018competitive, lopez2018cfd

% Other possible refs for dissolution/melting: yuan2017dynamics, claudin2017dissolution, hewett2017pear
