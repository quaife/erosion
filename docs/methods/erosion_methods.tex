...
based entirely on upsampling.  We are only interested in computing the
velocity and vorticity for visualizing the flow, and it is not necessary
that we resolve the integrands for arbitrarily close target points
