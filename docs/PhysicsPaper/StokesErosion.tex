...
With the flow and shear stresses computed, we seek to evolve the boundaries of erodable bodies through \eqref{Vn0}. For numerical stability, we modify \eqref{Vn0} to include a smoothing term that depends on local curvature $\kappa$, as in previous work \citep{quaife2018boundary}
\begin{align}
