...
\end{align}
The last term is the smoothing with strength $\epsilon \ll 1$. This term is proportion to the spatial average of the shear stress, $\langle\abs{\tau}\rangle$, and the mean curvature is subtracted inside the parenthesis so that this term preserves area. As such, the only source of material loss is the first term, $\CE \, \abs{\tau}$.
