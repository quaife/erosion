...
Similar statistical analysis is performed on the tortuosity measurements and shown in Fig.~\ref{fig6}. Much like before, the tortuosity measurements are grouped by the number of bodies, with the error bars showing little overlap across different values of $M$.
