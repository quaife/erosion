...
The hydrodynamic drag on the collection of bodies is obtained by integrating the surface traction over the boundary $\gamma$. The surface traction is given by 
\begin{equation}
- \stress \, \nn = p \nn + \tau \ss
\end{equation}
where the negative sign is a consequence of choosing the normal vector $\nn$ pointing {\em into} the bodies. The total drag on the collection of bodies is thus
\begin{equation}
...
\end{equation}
We will mostly be interested in the horizontal drag $\FD \cdot \ex$. \\
