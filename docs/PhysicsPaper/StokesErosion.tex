...
Consider first an isotropic medium with {\em scalar} permeability $k$. Equivalently, we can introduce a {\em resistivity} simply defined as the reciprocal of permeability, $r = 1/k$. Then taking the horizontal component gives
\begin{equation}
\label{q1}
...
\end{equation}
This formula gives the resistivity based on measurements of the pressure and discharge.
