...
\end{equation}
Combining with \eqref{eqn:k11} yields an approximate relationship between the horizontal components of permeability and drag 
\begin{equation}
\label{}
...
It will test how well the approach of measuring permeability works because drag is a much more precisely computed quantity.
It will test the approximate connection to Darcy law that we made.
