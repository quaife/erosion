...
The effects of flow-induced erosion are visible across a range of scales in the natural world, from massive geological structures \cite{abrams2009growth, perkins2015amplification, mac2020ultra, sharma2022alcove, mac2022morphological}, to mesoscopic patterns \cite{berhanu2012shape, bertagni2021hydrodynamic}, and down to the granular constituents of porous media \cite{zareei2022temporal}. The porous media encountered in nature typically exhibit material {\em anisotropy} in that they permit seepage flow in one direction more easily than in others. Typically, materials can be more permeable to flow in the longitudinal direction by a factor of 5-20 \cite{bear1988dynamics, anderson2015applied}.
...
\vsp{5}
% ORIGINAL BELOW
Effects of flow-induced erosion are visible across a range of scales, from massive geological structures, to mesoscopic patterns, and down to the tiny granular constituents that comprise a porous medium. 
In the case of a porous medium specifically, it has been long recognized that bulk properties of mediums encountered in nature are typically anisotropic, so that the medium allows flow in a preferred direction more easily. 
