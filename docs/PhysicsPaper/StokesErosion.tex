...
numerical methods described in both sections require that the geometry
is two-dimensional. Extending our work to three dimensions requires
entirely different time quadrature formulas and time stepping methods.}
